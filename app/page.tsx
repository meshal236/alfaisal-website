...
const COPY = {
  ar: {
    ...
    domains: [
      ...
      { mono: "OPERATIONS", title: "عمليات التشغيل والمراقبة", desc: "مراقبة الأنظمة الحرجة على مدار الساعة عبر مراكز التشغيل (NOC)، بإدارة حوادث سريعة وتقارير واضحة للقيادة." },
      ...
      { mono: "AI / LLM", title: "الذكاء الاصطناعي ووكلاء الذكاء الاصطناعي", desc: "خبرة وتطبيق في مجال خدمات الذكاء الاصطناعي ووكلاء الذكاء الاصطناعي المحلية والسحابية وMCP." },
