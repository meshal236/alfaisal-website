...
const COPY = {
  ar: {
    ...
    domains: [
      ...
      { mono: "CLOUD", title: "السحابة والافتراضية", desc: "بيئات تدمج مرونة السحابة العامة (Azure · GCP · Alibaba) ومراكز البيانات المحلية والبنى الافتراضية، ضمن تصميم موحّد وقابل للتوسع." },
      { mono: "AI / LLM", title: "الذكاء الاصطناعي", desc: "تبنٍّ عملي للذكاء الاصطناعي التوليدي — من التشغيل المحلي للنماذج إلى بناء منصات محادثة متعددة النماذج، ضمن استراتيجية تطبيق واضحة تناسب بيئة المؤسسة." },
