...
const COPY = {
  ar: {
    ...
    domains: [
      ...
      { mono: "CLOUD", title: "السحابة والافتراضية", desc: "بيئات هجينة تجمع السحابة العامة (Azure · GCP · Alibaba) ومراكز البيانات المحلية والبنى الافتراضية." },
      { mono: "AI / LLM", title: "الذكاء الاصطناعي التطبيقي", desc: "استخدام محلي للنماذج، منصات محادثة متعددة النماذج، واستراتيجيات تبنّي أدوات الذكاء الاصطناعي للمؤسسات." },
