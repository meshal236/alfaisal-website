...
const COPY = {
  ar: {
    ...
    domains: [
      { mono: "NETWORK", title: "الشبكات والأمن", desc: "تطبيق وتشغيل شبكات مراكز بيانات مؤسسية، سياسات وصول متقدمة، وحلول حماية متعددة الطبقات." },
      { mono: "OPERATIONS", title: "عمليات التشغيل والمراقبة", desc: "مراقبة الأنظمة الحرجة عبر مراكز المراقبة التشغيلية (NOC)، إدارة الحوادث، وتقارير تنفيذية للقيادة." },
      { mono: "ITSM", title: "حوكمة الخدمات التقنية", desc: "بناء عمليات إدارة الخدمات وفق ITIL، اتفاقيات مستوى الخدمة، ودورة حياة الطلبات والتغييرات." },
      { mono: "CLOUD", title: "السحابة والافتراضية", desc: "بيئات هجينة تدمج مرونة السحابة العامة (Azure · GCP · Alibaba) مع ثبات مراكز البيانات المحلية والبنى الافتراضية، ضمن تصميم موحّد وقابل للتوسع." },
      { mono: "AI / LLM", title: "الذكاء الاصطناعي التطبيقي", desc: "تبنٍّ عملي للذكاء الاصطناعي التوليدي — من التشغيل المحلي للنماذج إلى بناء منصات محادثة متعددة النماذج، ضمن استراتيجية تطبيق واضحة تناسب بيئة المؤسسة." },
      { mono: "LEADERSHIP", title: "قيادة الفرق والمشاريع", desc: "قيادة فرق تقنية متعددة التخصصات، إدارة مشاريع بنية تحتية، وترجمة التقنية إلى لغة القرار التنفيذي." },
    ],
